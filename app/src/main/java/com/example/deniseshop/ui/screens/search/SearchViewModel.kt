...
class SearchViewModel @Inject constructor(
	...
	private val _queryHistory = MutableStateFlow<Set<String>>(emptySet())
	...
	fun onDeleteSearchHistory(text: String){
		deleteSearchHistory(text)
	}

	private fun getSearchHistory(){
		getSearchHistoryUseCase(_query.value).onEach {
			_queryHistory.value = it
			Log.d("SEARCH_VM", it.toString())
		}.launchIn(viewModelScope)
	}

	private fun deleteSearchHistory(text: String){
		viewModelScope.launch {
			deleteSearchHistoryUseCase(text)
		}
	}
